...
@interface XLsn0wDatePicker () <UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation XLsn0wDatePicker
...
- (void)selectedOk {
    self.pickerBlock(self, self.year, self.month, self.day);
